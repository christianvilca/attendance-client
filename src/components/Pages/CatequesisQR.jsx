...
const CatequesisQR = ({ match, ...props }) => {
	const hanldeChange = () => {};

	const propsHeader = {
		title: 'Codigo de Catequesis',
		to1: 'goBack',
		icon1: 'arrow-back',
		...
		<ContainerDetail propsHeader={propsHeader} {...props}>
			<div className="container-detail">
				...
				<div className="container-detail__text">
					<InputText name="name" label="Catequesis" value={value} onChange={hanldeChange} />
				</div>
			</div>
		</ContainerDetail>
	);
